    ...
    <>
      ...
      <form className={layout} method="post" enctype="multipart/form-data" onSubmit={handleSubmit(onSubmit)}>
        <div className={container}>
          ...
          <input className={text} placeholder="제목을 입력해주세요."type="text" {...register("title")}/>
        </div>
        <div className={container}>
          <div className={title} >작성방법</div>
          <fieldset className={containerWriteWay}>
              <input className={writeWay} id="writeWaySimple" type="radio" name="writeWay" value="simple" {...register("writeWay")} checked/>
              <label className={writeWaySelect} for="writeWaySimple" >간단하게</label>
              <input className={writeWay} id="writeWayDetail" type="radio" name="writeWay" value="detail" {...register("writeWay")}/>
              <label className={writeWaySelect} for="writeWayDetail">자세하게</label>
          </fieldset>
        </div>
        <div className={container} >
          <div className={title} >내용</div>
          <textarea className={textarea} placeholder="내용을 입력해주세요." {...register("content")} cols="30" rows="10"></textarea>
        </div>
        <div className={container}>
          ...
          <div className={boxButtonUpload}>
            ...
            <input className={ir} {...register("image")}  onChange={(e) => changeFileName(e) } type="file" id="file" />
          </div>
        </div>
        <div className={container}>
        ...
        <div className={container}>
          <div className={boxButtonsSubmit}>
            ...
            <LinkButton to="/myRecipe/list" type="submit" size="large">취소</LinkButton>
          </div>
        </div>
      </form>
    </>
