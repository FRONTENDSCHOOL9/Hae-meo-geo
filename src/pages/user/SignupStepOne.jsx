...
function SignupStepOne(){
  ...
  const handleRequiredCheckboxChange = () => {
    const areAllRequiredChecked = Array.from(document.querySelectorAll('input[type="checkbox"]'))
  ...
  const handleNextButtonClick = () => {
    const anyCheckboxUnchecked = checkboxesRef.current.some(checkbox => !checkbox.checked);
    
    anyCheckboxUnchecked ? alert("[필수] 항목에 체크해주세요") : navigate("/user/signupStepTwo");
  };
